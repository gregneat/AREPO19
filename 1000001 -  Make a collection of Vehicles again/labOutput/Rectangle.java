...
public class Rectangle implements Shape
{
    ...
    */
	...
	// try adding a contains method
	// updated with OFFSETs cuz of banner at top of frame
	
	public boolean contains(double x, double y)
	{
		if(x >= getX()+XOFFSET && x <= getX()+XOFFSET +getWidth())
		{
			if(y >= getY()+YOFFSET && y <= getY()+YOFFSET+ getHeight())
			{
				return true;
			}
			else
